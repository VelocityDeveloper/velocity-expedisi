                ...
                <div class="card m-0 p-0 form-tarif">
                    ...
                    <form action="" method="post" class="card-body">
                        <div class="form-floating mb-3">
                            <select class="form-select selectcity" id="asal" name="asal" placeholder="<?php echo strtolower($label_asal); ?>">
                                <option value="">Pilih <?php echo $label_asal; ?></option>
                            </select>
                            <label for="asal"><?php echo $label_asal; ?></label>
                        </div>
                        <div class="form-floating mb-3">                        
                            <select class="form-select selectcity" id="tujuan" name="tujuan" placeholder="<?php echo strtolower($label_tujuan); ?>">
    ...
    jQuery(function($){
        ...
        function optioncity(){
            ...
            if (!Array.isArray(datacity)) {
                ...
                populateCity(datacity); 
            }
        }

        function populateCity(datacity) {
            if (!Array.isArray(datacity)) return;

            var opt = '<option value="">Pilih <?php echo $type == "internasional" ? "Negara" : "Kota"; ?></option>';
