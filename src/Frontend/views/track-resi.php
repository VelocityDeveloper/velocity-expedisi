    ...
    <div x-show="hasSearched">
        <template x-if="resi">
            <div class="tracking-result card shadow-sm">
                <div class="card-header bg-primary text-white d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3">
                    <h5 class="mb-0">Hasil Pelacakan: <span x-text="resi.no_resi" class="d-block d-sm-inline mt-1 mt-sm-0"></span></h5>
                    <a :href="'<?php echo home_url('/'); ?>?download_resi_pdf=1&no_resi=' + resi.no_resi" class="btn btn-light btn-sm d-flex align-items-center justify-content-center" target="_blank">
                            ...
                            <div class="timeline-items">
                                <template x-for="step in tracking" :key="step.id">
                                    <div class="timeline-item d-flex mb-3">
                                        <div class="timeline-date me-2 me-sm-3 text-start text-sm-end" style="min-width: 80px; width: 80px; sm-min-width: 120px; sm-width: 120px;">
                                            <div class="fw-bold small" x-text="formatDate(step.waktu)"></div>
                                            <small class="text-muted" x-text="formatTime(step.waktu)"></small>
                                        </div>
                                        <div class="timeline-content ps-3 border-start position-relative flex-grow-1">
